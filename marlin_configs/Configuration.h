...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  19.55  // Aldo (calibrate)
    #define DEFAULT_Ki   1.25  // Aldo (calibrate)
    #define DEFAULT_Kd  76.25  // Aldo (calibrate)
  #endif
#else
 ...
 */
// #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  // Aldo

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING  // Aldo
 ...
 */
#define Z_MIN_PROBE_PIN PC12 // Pin 32 is the RAMPS default  // Aldo
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -59, -28, 0 }  // Aldo
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // Aldo
...
#define AUTO_BED_LEVELING_BILINEAR  // Aldo
//#define AUTO_BED_LEVELING_UBL
//#define MESH_BED_LEVELING  // Aldo
 ...
 */
#define RESTORE_LEVELING_AFTER_G28  // Aldo
// #define ENABLE_LEVELING_AFTER_G28  // Aldo

/**
 * Auto-leveling needs preheating
 */
#define PREHEAT_BEFORE_LEVELING  // Aldo
#if ENABLED(PREHEAT_BEFORE_LEVELING)
  #define LEVELING_NOZZLE_TEMP 120   // (°C) Only applies to E0 at this time
  #define LEVELING_BED_TEMP     60  // Aldo
#endif
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define PROBE_Y_FIRST
    ...
    // #define EXTRAPOLATE_BEYOND_GRID  // Aldo
